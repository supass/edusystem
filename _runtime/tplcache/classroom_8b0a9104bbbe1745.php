...
function setCreditScore(num){
	...
	setTimeout(function(){
        ...
        <script>
            $(function(){
                //异步加载我的问题
                var url="<?php echo U('classroom/Home/getWenda');?>";
                $.ajax({
                    type:"POST",
                    url:url,
                    dataType:"json",
              ...
              //点击查看更多事件
                $(".more").click(function(){
                    ...
                    $.post("<?php echo U('classroom/Home/"+type+"');?>",{page:page},function(data){
            ...
            var id=id;
           $.post("<?php echo U('wenda/Index/delWenda');?>", {id:id}, function(res){
                   if(res==200){
                       location.reload();
                   }else{
