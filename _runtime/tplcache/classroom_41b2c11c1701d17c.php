<?php if (!defined('THINK_PATH')) exit();?><select class="inputcheckbox select" name="province" id="province" onchange="changeArea(this)"></select>
<select class="inputcheckbox select" name="city" id="city" onchange="changeArea(this)"></select>
<select class="inputcheckbox select" name="area" id="area" onchange="changeArea(this)"></select>
<input event-node="input_area" type="hidden" id="current" name="city_ids" value="<?php echo ($selected); ?>"/>
<input type="hidden" id="current_name" name="city_names" value="<?php echo ($city_names); ?>" />

<script type="text/javascript">
var json = eval(<?php echo ($list); ?>);			// 地区JSON数据
var arrNodeChild = new Array();		// 子树数组
var selected = '<?php echo ($selected); ?>';		// 默认选中的地区
