...
<div id="container" class="so_main">
  ...
  <?php }else{ ?>
   ...
   <form method="POST" action="<?php echo ($savePostUrl); ?>" <?php if(($onsubmit)  !=  ""): ?>onsubmit = "return <?php echo ($onsubmit); ?>;"<?php endif; ?> name='detail_form'>
    ...
    <?php endif; /*非隐藏域*/ ?>  
        ...
        <?php echo W('Upload',array('uploadType'=>'file','inputname'=>$pk,'attachIds'=>$defaultS, 'limit'=>1));?>
        </div>
        <?php endif; ?>
