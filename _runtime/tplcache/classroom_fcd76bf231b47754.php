...
<div class="worap position-rt">
    ...
    <div class="user-con fl user-pbottom">
        ...
        <a <?php echo ($tab==0 ?' class="onactive"':''); ?> href="<?php echo U('classroom/User/account');?>">余额</a>
<a <?php echo ($tab==5 ?' class="onactive"':''); ?> href="<?php echo U('classroom/User/account', array('tab'=>5));?>">充值记录</a>
<a <?php echo ($tab==2 ?' class="onactive"':''); ?> href="<?php echo U('classroom/User/account', array('tab'=>2));?>">支付记录</a>
<a <?php echo ($tab==3 ?' class="onactive"':''); ?> href="<?php echo U('classroom/User/account', array('tab'=>3));?>">提现记录</a>
   
        </div>
        <div class="user-Release" >
          <div class="tx_r_m Manage_all" style="display:block; text-align:center">
                <p class="txt_r ft24 pb20"> 可用余额 <em class="green_txt ft30 mlr22"><?php echo unLast0($userLearnc['balance']);?></em>学币<a class="green_txt ft14 ml20" href="<?php echo U('classroom/User/card');?>">绑定银行卡</a><a class="green_txt ft14 ml20" href="<?php echo U('classroom/User/account', array('tab'=>4));?>">提现￥</a></p>
            </div>  
        </div>
    </div>
    <!--右-->
