  ...
  <div class="user-con fl user-pbottom">
    ...
    <div class="user-Release" >
      <div class="rec_box_r Manage_all" style="display:block;">
        <form action="<?php echo U('classroom/Pay/recharge');?>" method="post" target="_blank">
          ...
          <div class="btn_je_box clearfix">
            ...
            <a class="btn_hui_h" href="javascript:;" val="<?php echo ($val); ?>"><?php echo ($val); ?>元</a>
            <?php endforeach;?>
          </div>
      ...
      <div class="rec_box_r Manage_all" style="display:none;">
        <form action="<?php echo U('classroom/Pay/rechargeVip');?>" method="post" target="_blank">
          <input type="hidden" value="alipay" name="pay" />
          <input type="hidden" value="0" name="type" />
          <div class="clearfix h55">
            <p > <span class="selected_title f9 fl">Eduline帐号:</span><em class="fb "><?php echo ($user['uname']); ?></em> </p>
          ...
          <div class="mt10 nf_bg_div h78 clearfix">
            <div class="nf_bg nf_bg1 border_bg fl select_time" val="0" price="<?php echo ($vipPrice[0]); ?>"><a href="javascript:;">&nbsp;&nbsp;年费<em class="red_txt"><?php echo ($vipPrice[0]); ?></em>元(原价<?php echo ($vipPrice[1]); ?>)</a><b class="nf_bg_em"></b></div><p class="nf_bg_p">&nbsp;&nbsp;&nbsp;推荐购买，仅<?php echo ($vipPrice[3]); ?>元/月，节省<?php echo ($vipPrice[1]-$vipPrice[0]); ?>元</p>
            <div class="nf_bg nf_bg2 fl select_time" val="1" price="<?php echo ($vipPrice[2]); ?>"><a class="f_p" href="javascript:;"><em class="fl">&nbsp;&nbsp;按月</em>
              <input class="w70" id="recharge_month" name="month" type="text" maxlength="2">
              个月</a><b></b></div>
            
            <p class="nf_bg_p" style="display:none">按月购买，每月只需<?php echo ($vipPrice[2]); ?>元</p>
          </div>--->
          
          <div class="mt10 nf_bg_div clearfix">

                                 <div class="nf_bg nf_bg1 border_bg fl select_time" val="0" price="<?php echo ($vipPrice[0]); ?>" style="margin-right:15px; width:145px;"><a href="javascript:;" class="font12" >&nbsp;&nbsp;年费<em class="red_txt"><?php echo ($vipPrice[0]); ?></em>元(原价<?php echo ($vipPrice[1]); ?>)</a><b class="nf_bg_em"></b></div>
                                 <div class="nf_bg nf_bg2 fl select_time" val="1" price="<?php echo ($vipPrice[2]); ?>"><a class="f_p font12 " href="javascript:;" style="background:none;"><span class="vip_month">按月<input class="w70" id="recharge_month" name="month" type="text" maxlength="2">月</span></a><b></b></div>
                             <p class="nf_bg_p">推荐购买，仅<?php echo ($vipPrice[3]); ?>元/月，节省<?php echo ($vipPrice[1]-$vipPrice[0]); ?>元</p>
                             <p class="nf_bg_p" style="display:none">按月购买，每月只需<?php echo ($vipPrice[2]); ?>元</p>
                            </div>
...
function rechange(sbt){
	var rechange_base = parseFloat('<?php echo getAppConfig("rechange_basenum");?>');
