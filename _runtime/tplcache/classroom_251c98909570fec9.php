...
<script>
    ...
    var magstatus;
    $(function(){
        var url="<?php echo U('classroom/Home/getbuyalbumslist');?>";
    ...
    function navClick(cate,type){
        ...
        if(type=="getbuyalbumslist"){
            url="<?php echo U('classroom/Home/getbuyalbumslist');?>";
        }else if(type=="getcollectalbumslist"){

            url="<?php echo U('classroom/Home/getcollectalbumslist');?>";
        }else if(type=="getuploadalbumslist"){
            $("#sel_ok").removeClass("current");
            $("#sel_w").addClass("current");
            $(".user-Release").show();
            fdata="type=1";
            url="<?php echo U('classroom/Home/getuploadalbumslist');?>"
        }else{
            url="<?php echo U('classroom/Home/getbuyalbumslist');?>";
        }
