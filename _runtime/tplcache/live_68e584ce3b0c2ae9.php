...
<div id="container" class="so_main">
 ...
 <!-- START TOOLBAR -->
  <div class="Toolbar_inbox">
    <div class="page right"><span>共<?php echo ($listData["count"]); ?>条</span><?php echo ($listData["html"]); ?></div>  
  ...
  <tr>
   ...
   <?php if(is_array($pageKeyList)): ?><?php $i = 0;?><?php $__LIST__ = $pageKeyList?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$pk): ?><?php ++$i;?><?php $mod = ($i % 2 )?><?php $key = $pk;
    ...
    <th class="line_l" <?php if($name=="id" || $name=="分类" || $name=="热"): ?> style="width:30px;"<?php endif; ?> <?php if($name=="操作"): ?> style="width:auto;"<?php endif; ?> ><?php echo ($name); ?></th><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
  </tr>
