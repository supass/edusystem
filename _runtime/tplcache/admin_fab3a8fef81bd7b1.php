  ...
  <tr>
    <td colspan="3">
		<div class="header"><!-- 头部 begin -->
		    ...
		    <div class="nav_sub">
		    	<?php echo L('PUBLIC_HELLO');?>,<?php echo ($user["uname"]); ?>&nbsp; | <a target="_blank" href="<?php echo U('classroom/Index/index');?>"><?php echo L('SYSTEM_BACK_TO_FRONT');?></a> | <a href="javascript:void(0);" onClick="refresh();"><?php echo L('SYSTEM_REFRESH');?></a> | <a href="<?php echo U('admin/Public/logout');?>"><?php echo L('PUBLIC_LOGOUT');?></a><br/>
		    	<div id="TopTime"></div>
		    </div>
		    <div class="main_nav">
		    	<?php if(is_array($channel)): ?><?php $i = 0;?><?php $__LIST__ = $channel?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><a id="channel_<?php echo ($key); ?>" <?php if(($key)  ==  "index"): ?>class="on"<?php endif; ?> href="javascript:void(0)" onclick="switchChannel('<?php echo ($key); ?>');" hidefocus="true" <?php if(strlen($vo)>9): ?>style="outline:none; margin:0 9px 0 9px;"<?php else: ?>style="outline:none;"<?php endif; ?>><?php echo ($vo); ?></a><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>	
